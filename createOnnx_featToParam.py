...
output_names = ['landmark', 'confidence', 'params'] #[B,486,3], [B]


onnx_file_name = "BlazeFaceParams_{}_{}_{}_BGRxByte.onnx".format(batch_size, height, width)
dynamic_axes = {
    "input": {0: "batch_size"}, 
